"""
Django settings for apple_sauce_dev_60853 project.
...
ROOT_URLCONF = 'apple_sauce_dev_60853.urls'
...
WSGI_APPLICATION = 'apple_sauce_dev_60853.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "apple_sauce_dev_60853 API",
    "DESCRIPTION": "API documentation for apple_sauce_dev_60853 App",
    "VERSION": "v1",
}
